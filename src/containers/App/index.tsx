...
const GlobeIcon = require("../../assets/globe.png");
const Fastly = require("../../assets/4.png");
const Write = require("../../assets/1.png");
const Dissect = require("../../assets/2.png");
const Fasm = require("../../assets/3.png");
